...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="py-20 md:py-28 relative overflow-hidden">
      ...
      {/* Section glow — blue + purple blend */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] rounded-full pointer-events-none" style={{ background: "radial-gradient(ellipse, hsl(230 70% 58% / 0.05) 0%, hsl(270 60% 55% / 0.03) 50%, transparent 70%)" }} />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.div
              ...
              className="hidden md:block absolute top-10 left-[12.5%] right-[12.5%] h-px origin-left"
              style={{ background: "linear-gradient(90deg, hsl(230 70% 58% / 0.2), hsl(270 60% 55% / 0.3), hsl(45 95% 55% / 0.2))" }}
            />
            ...
            {steps.map((s, i) => (
              ...
              >
                <motion.div
                  ...
                  className="w-14 h-14 rounded-2xl bg-primary flex items-center justify-center mb-5 relative z-10 transition-shadow duration-300 group-hover:shadow-[0_0_30px_-5px_hsl(270_60%_55%/0.4)]"
                ...
                <motion.span
                  ...
                  className="text-xs font-bold text-primary mb-2 tracking-wide uppercase"
                >
                  Step {i + 1}
                </motion.span>
